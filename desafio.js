...
function realizarCompra1(comprasdaCliente) {
    let valorTotal = 0
...
function realizarCompra2(comprasdaCliente) {
    let valorTotal = 0
    let descontoAplicado = 0
    let valorFinal = 0
    let quantidadeDeProdutos = comprasdaCliente.length
...
realizarCompra2(clienteDeborah)
...
function realizarCompra3(comprasdaCliente) {
    let valorTotal = 0
    let descontoAplicado = 0
    let valorFinal = 0
    let quantidadeDeProdutos = comprasdaCliente.length
